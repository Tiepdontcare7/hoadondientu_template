            ...
            <div className="flex gap-x-[20px] items-center pl-[20px]">
              ...
              <div className={``}>
                <span
                  ...
                  title="Xem hoa đơn"
                  className={`${
                    idBill ? "cursor-pointer hover:bg-slate-500 hover:text-white" : "cursor-not-allowed select-none"
                    ...
                    <div className="ant-row-flex ant-row-flex-center day">
                      <div className="ant-col ant-col-24">
                        <div className="ant-row-flex ant-row-flex-center flex justify-center">
                          <div>01</div> /<div>02</div> /<div>2025</div>
                        </div>
                    ...
                    <li>
                      <div className="styles__DataItemStyle-sc-v1ei30-1 cdheZW">
                        <div className='class="styles__DataItemStyle-sc-v1ei30-1 cdheZW flex'>
                          ...
                          <div>
                            <div className="di-value">{dataBill?.Tên_người_bán}</div>
                          </div>
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div className="styles__DataItemStyle-sc-v1ei30-1 cdheZW">
                        <div className='class="styles__DataItemStyle-sc-v1ei30-1 cdheZW flex'>
                          ...
                          <div>
                            <div className="di-value">{dataBill?.Mã_số_thuế}</div>
                          </div>
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div className="styles__DataItemStyle-sc-v1ei30-1 cdheZW">
                        <div className='class="styles__DataItemStyle-sc-v1ei30-1 cdheZW flex'>
                          ...
                          <div>
                            <div className="di-value">{dataBill?.Địa_chỉ}</div>
                          </div>
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div className="styles__DataItemStyle-sc-v1ei30-1 cdheZW">
                        <div className='class="styles__DataItemStyle-sc-v1ei30-1 cdheZW flex'>
                          ...
                          <div>
                            <div className="di-value">{dataBill?.Điện_thoại}</div>
                          </div>
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div className="styles__DataItemStyle-sc-v1ei30-1 cdheZW">
                        <div className='class="styles__DataItemStyle-sc-v1ei30-1 cdheZW flex'>
                          ...
                          <div>
                            <div className="di-value">{dataBill?.Số_tài_khoản}</div>
                          </div>
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div className="styles__DataItemStyle-sc-v1ei30-1 cdheZW">
                        <div className='class="styles__DataItemStyle-sc-v1ei30-1 cdheZW flex'>
                          ...
                          <div>
                            <div className="di-value">CÔNG TY TNHH MỘT THÀNH VIÊN CÔNG NGHỆ VÀ TRUYỀN THÔNG 3I</div>
                          </div>
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div className="styles__DataItemStyle-sc-v1ei30-1 cdheZW">
                        <div className='class="styles__DataItemStyle-sc-v1ei30-1 cdheZW flex'>
                          ...
                          <div>
                            <div className="di-value">{dataBill?.Tên_người_mua}</div>
                          </div>
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div className="styles__DataItemStyle-sc-v1ei30-1 cdheZW">
                        <div className='class="styles__DataItemStyle-sc-v1ei30-1 cdheZW flex'>
                          ...
                          <div>
                            <div className="di-value">{dataBill?.Mã_số_thuế_buyer}</div>
                          </div>
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div className="styles__DataItemStyle-sc-v1ei30-1 cdheZW">
                        <div className='class="styles__DataItemStyle-sc-v1ei30-1 cdheZW flex'>
                          ...
                          <div>
                            <div className="di-value">{dataBill?.Địa_chỉ_buyer}</div>
                          </div>
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div className="styles__DataItemStyle-sc-v1ei30-1 cdheZW">
                        <div className='class="styles__DataItemStyle-sc-v1ei30-1 cdheZW flex'>
                          ...
                          <div>
                            <div className="di-value">{dataBill?.Số}</div>
                          </div>
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div className="styles__DataItemStyle-sc-v1ei30-1 cdheZW">
                        <div className='class="styles__DataItemStyle-sc-v1ei30-1 cdheZW flex'>
                          ...
                          <div>
                            <div className="di-value">{dataBill?.Hình_thức_thanh_toán}</div>
                          </div>
                        </div>
                      </div>
                    </li>
                    ...
                    <li>
                      <div className="styles__DataItemStyle-sc-v1ei30-1 cdheZW">
                        <div className='class="styles__DataItemStyle-sc-v1ei30-1 cdheZW flex'>
                          ...
                          <div>
                            <div className="di-value">{dataBill?.Đơn_vị_tiền_tệ}</div>
                          </div>
                        </div>
                      </div>
                    </li>
                        ...
                        <thead className="ltr:text-left rtl:text-right">
                          <tr>
                            <th className=" border px-3 py-2 font-medium text-gray-900">
                              Tổng tiền chưa thuế (Tổng cộng thành tiền chưa có thuế)
                            </th>
                            <th className=" border px-3 py-2 font-medium text-gray-900">
                              {dataBill?.tables[3]?.Tổng_tiền_thanh_toán_bằng_số}{" "}
                            </th>
                          </tr>
                        </thead>
