...
const HomePage = () => {
  ...
  return (
    <section className='ant-layout grid grid-cols-7 bg-[#FBF4EC]'>
      <div className='ant-row-flex styles__DropdownMenuWrapper-sc-1opqjrn-0 lfhmMP ml-menu'>
        <div className='ant-row-flex ant-row-flex-center'>
          <div className='ant-col ant-col-xs-24 ant-col-sm-24 ant-col-md-24 ant-col-lg-22'>
            <div className='flex gap-x-[20px] ant-row-flex flex-space'>
