      ...
      <div className="ant-row-flex styles__DropdownMenuWrapper-sc-1opqjrn-0 lfhmMP ml-menu">
        <div className="ant-row-flex ant-row-flex-center">
          <div className="ant-col ml-menu-item">
            ...
            <div
              onClick={toggleMenu}
              className="flex gap-x-[10px] py-2 select-none cursor-pointer  styles__MenuWrapper-sc-1opqjrn-4 eItfNu ant-dropdown-trigger"
            >
              <img
                width={20}
                src="https://hoadondientu.gdt.gov.vn/static/images/ic_ql_tao_lap.svg"
                className="styles__IconImage-sc-1opqjrn-1 fsvLlA"
                alt=""
              />
              <span>Tra cứu</span>
            ...
            <ul
              className={`bg-white ant-dropdown-menu ant-dropdown-menu-light ant-dropdown-menu-root ant-dropdown-menu-vertical ${
                isMenuOpen ? "hidden" : ""
              }`}
            >
              <li
                role="menuitem"
                className=" hover:bg-slate-200 px-2 py-1 ant-dropdown-menu-item styles__MenuItem-sc-1opqjrn-2 eygjqL"
              >
